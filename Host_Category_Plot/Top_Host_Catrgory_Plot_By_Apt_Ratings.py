...
def Top_Host_Category_Plot_By_Apt_Rating(val1,val2,val3):
    ...
    if(float(val2)<=6):
        ...
        df2 = data.loc[(data['Country'] == val1) & (data['Review_Rating']>=float(val2)) & (data['Room_Type']==val3)]
    Name_Cord_DF = df2[['Name','Country','Price','Room_Type','Review_Rating']]
    ...
    Name_Cord_DF.to_csv("/Users/shashankkaundal/Downloads/AirBnbAnalysis/Host_Category_Plot/Host_By_Ratings_Apt_Room.csv",
                       index=False)
