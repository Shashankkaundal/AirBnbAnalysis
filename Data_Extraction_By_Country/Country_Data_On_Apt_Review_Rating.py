...
def Get_Type_Of_Place_From_Apt_Rating(val1, val2,val3):
    ...
    Name_Cord_DF.to_csv("/Users/shashankkaundal/Downloads/AirBnbAnalysis/Data_Extraction_By_Country/Cord_Apt_Review_Type.csv",
                        index=False)
    return Name_Cord_DF
