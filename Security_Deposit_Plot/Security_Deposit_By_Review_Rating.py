...
def Security_Deposits_By_Review_Ratings(val1, val2):
    ...
    if(float(val2)<=6):
        ...
        df2 = data.loc[(data['Country'] == val1) & (data['Review_Rating'] >= float(val2))]
    Name_Cord_DF = df2[['Name', 'Country', 'Price', 'Security_Deposit','Review_Rating']]
    ...
    df.to_csv("/Users/shashankkaundal/Downloads/AirBnbAnalysis/Security_Deposit_Plot/Sec_Deposit_Review_Rating.csv",
              index=False)
    data = [str1]
